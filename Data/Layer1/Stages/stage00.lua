...
stage_info._0_Title = "Stage00 Layer1をManualで体験"
...
stage.GenerateMaze = function(_seed)
    ...
    local map = GenMaze.GenerateMaze(5, 5, rand)
    ...
    -- device, item, prowler
    local list = GenMaze.GetRandomFloorPointList(wpos, 6)
    -- for i, v in ipairs(list) do
    --     print(i .. " : key=" .. v.key .. ", x=" .. v.x .. ", y=" .. v.y)
    -- end
